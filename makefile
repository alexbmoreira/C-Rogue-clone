...
a1: a1.c graphics.c visible.c utils.c generation.c states.c perlin.c graphics.h utils.h generation.h states.h perlin.h
	gcc a1.c graphics.c visible.c utils.c generation.c states.c perlin.c -o a1 $(LIBS)
