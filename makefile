...
a1: a1.c graphics.c visible.c utils.c generation.c states.c graphics.h utils.h generation.h states.h
	gcc a1.c graphics.c visible.c utils.c generation.c states.c -o a1 $(LIBS)
