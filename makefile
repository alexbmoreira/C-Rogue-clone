...
a1: a1.c graphics.c visible.c utils.c generation.c states.c perlin.c clouds.c mesh.c map.c graphics.h utils.h generation.h states.h perlin.h clouds.h colors.h mesh.h fast_obj.h map.h
	gcc a1.c graphics.c visible.c utils.c generation.c states.c perlin.c clouds.c mesh.c map.c -o a1 $(LIBS)
