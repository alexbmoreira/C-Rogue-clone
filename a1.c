...
void setColors() {
   ...
   setUserColour(CLR_U_STAIR, BLOCK_BLACK[0], BLOCK_BLACK[1], BLOCK_BLACK[2], BLOCK_BLACK[3], BLOCK_BLACK[4], BLOCK_BLACK[5], BLOCK_BLACK[6], BLOCK_BLACK[7]);
   ...
   setUserColour(CLR_DG_WALL, BLOCK_DUNGEONWALLS[0], BLOCK_DUNGEONWALLS[1], BLOCK_DUNGEONWALLS[2], BLOCK_DUNGEONWALLS[3], BLOCK_DUNGEONWALLS[4], BLOCK_DUNGEONWALLS[5], BLOCK_DUNGEONWALLS[6], BLOCK_DUNGEONWALLS[7]);
   setUserColour(CLR_DG_FLOOR, BLOCK_DUNGEONFLOORS[0], BLOCK_DUNGEONFLOORS[1], BLOCK_DUNGEONFLOORS[2], BLOCK_DUNGEONFLOORS[3], BLOCK_DUNGEONFLOORS[4], BLOCK_DUNGEONFLOORS[5], BLOCK_DUNGEONFLOORS[6], BLOCK_DUNGEONFLOORS[7]);
   setUserColour(CLR_GRASS, BLOCK_GRASS[0], BLOCK_GRASS[1], BLOCK_GRASS[2], BLOCK_GRASS[3], BLOCK_GRASS[4], BLOCK_GRASS[5], BLOCK_GRASS[6], BLOCK_GRASS[7]);
